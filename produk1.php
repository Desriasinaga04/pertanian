...
<div class="container-fluid banner-produk d-flex align-items-center">
    <div class="container">
        <h1 class="text-white text-center">Produk</1>
    </div>
</div>
    <!--body-->
<div class="container py-5">
<div class="row">
    <div class="col-lg-3" style="border: solid red; height: 300px"></div>
    <div class="col-lg-9" style="border: solid blue; height: 300px"></div>
</div>
</div>
