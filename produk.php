...
function generateRandomString($length=10){
    ...
    $randomString='';
    for($i=0;$i< $length;$i++){
        $randomString .= $karakter[rand(0,$karakterlength - 1)];
    }
    return $randomString;
    }
?>
          ...
          <div class="container mt-5">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <a href="index.php" class="no-decoration text-muted"><i class="fas fa-house"> </i>   Home </a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">
                        ...
                        <?php
                                ...
                                if($nama_file!=''){
                                    if($image_size > 500000){
                                      ?>
                                      <div class="alert alert-warning mt-3" role="alert">
                                        Foto tidak boleh melebihi 500kb
                                      </div>
                                      <?php  
                                    }
                                    else{
                        ...
                        if($jumlahProduk==0){
                            ...
                            while($data=mysqli_fetch_array($query)){
                                ...
                                <tr>
                                   ...
                                   <!-- <td><a href="produk_detail1.php?p=<?php echo $data['id'];?>">Edit</a></td>-->
                                    <td><a href="delete.php?p=<?php echo $data['id']; ?>">Hapus</a></td> 
                                </tr>
                                <?php
                                $jumlah++;
                            }
