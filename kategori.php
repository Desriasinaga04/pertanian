        ...
        <?php require "navbar.php";?>
          <div class="container mt-5">
           ...
           <div class="my-5 col-12 col-md-6">
               <b> <h3>Tambah Kategori</h3>
                <form action="" method="post">
                    <div>
                        <label for="kategori text-black">Kategori</label>
                        ...
                        <?php
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td><a href="kategori_detail.php?p=<?php echo $data['id'];?>"
                                    class="btn btn-info"><i class="fas fa-search"></i></a></td>
                                </tr>
                            <?php
                             $jumlah++;
                            }
